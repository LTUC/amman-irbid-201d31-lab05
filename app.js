...
function multiply(a, b) {
  ...
  let fig1=a;
  let fig2=b;
  let product=fig1*fig2;
  let note='The product of 5 and 9 is 45.'
...
function sumArray(sumArr) {
  let tre=sum(testArray [0],testArray [1])[0];
...
function multiplyArray(multArr) {
  ...
  let num4=multiply(testArray[0],testArray[1])[0];
  let num5=multiply(num4,testArray[2])[0];
  

  
  
  let note4='The numbers 2,3,4 have a product of 24.'
